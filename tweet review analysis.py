...
def main():
    ...
    hashtag = input("Enter the hashtag for anything you want to review: ")
    ...
    performance = [100 * len(ptweets) / len(tweets), 100 * len(ntweets) / len(tweets),
                   100 * len(neutweets) / len(tweets)]
